...
#define ORIGINAL_FILE_NAME "UE4Editor-SocketTelemetry.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_PROJECT_NAME SocketTelemetry
...
#define SOCKETTELEMETRY_API DLLEXPORT
